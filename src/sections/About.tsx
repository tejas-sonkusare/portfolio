  ...
  return (
    <section id="about" className="section">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        ...
        >
          <div className="glass rounded-2xl p-5 sm:p-6 md:p-8 mb-6 sm:mb-8">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 justify-center">
              {skills.map((s, i) => (
                <motion.span
                  ...
                  viewport={{ once: true }}
                >
                  <span className="glass px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm hover:shadow-glow transition-all duration-300 inline-block">
                    {s}
                  </span>
                </motion.span>
              ))}
